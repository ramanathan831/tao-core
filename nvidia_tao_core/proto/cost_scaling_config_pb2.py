...
# source: nvidia_tao_core/proto/cost_scaling_config.proto
...
CostScalingConfig = _reflection.GeneratedProtocolMessageType('CostScalingConfig', (_message.Message,), dict(
  ...
  __module__ = 'nvidia_tao_core.proto.cost_scaling_config_pb2'
