...
# source: nvidia_tao_core/proto/detection_sequence_dataset_config.proto
...
DataSource = _reflection.GeneratedProtocolMessageType('DataSource', (_message.Message,), dict(
  ...
  __module__ = 'nvidia_tao_core.proto.detection_sequence_dataset_config_pb2'
...
_DATASETCONFIG_TARGETCLASSMAPPINGENTRY.has_options = True
_DATASETCONFIG_TARGETCLASSMAPPINGENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
