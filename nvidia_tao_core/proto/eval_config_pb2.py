...
# source: nvidia_tao_core/proto/eval_config.proto
...
EvalConfig = _reflection.GeneratedProtocolMessageType('EvalConfig', (_message.Message,), dict(
  ...
  __module__ = 'nvidia_tao_core.proto.eval_config_pb2'
