...
# source: nvidia_tao_core/proto/sgd_optimizer_config.proto
...
SGDOptimizerConfig = _reflection.GeneratedProtocolMessageType('SGDOptimizerConfig', (_message.Message,), dict(
  ...
  __module__ = 'nvidia_tao_core.proto.sgd_optimizer_config_pb2'
