...
# source: nvidia_tao_core/proto/soft_start_annealing_schedule_config.proto
...
SoftStartAnnealingScheduleConfig = _reflection.GeneratedProtocolMessageType('SoftStartAnnealingScheduleConfig', (_message.Message,), dict(
  ...
  __module__ = 'nvidia_tao_core.proto.soft_start_annealing_schedule_config_pb2'
