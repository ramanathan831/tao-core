...
# source: nvidia_tao_core/proto/clearml_config.proto
...
ClearMLConfig = _reflection.GeneratedProtocolMessageType('ClearMLConfig', (_message.Message,), dict(
  ...
  __module__ = 'nvidia_tao_core.proto.clearml_config_pb2'
