...
# source: nvidia_tao_core/proto/class_weighting_config.proto
...
ClassWeightingConfig = _reflection.GeneratedProtocolMessageType('ClassWeightingConfig', (_message.Message,), dict(
  ...
  ClassWeightingEntry = _reflection.GeneratedProtocolMessageType('ClassWeightingEntry', (_message.Message,), dict(
    ...
    __module__ = 'nvidia_tao_core.proto.class_weighting_config_pb2'
...
_CLASSWEIGHTINGCONFIG_CLASSWEIGHTINGENTRY.has_options = True
_CLASSWEIGHTINGCONFIG_CLASSWEIGHTINGENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
