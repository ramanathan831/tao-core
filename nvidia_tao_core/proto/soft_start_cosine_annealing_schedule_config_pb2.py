...
# source: nvidia_tao_core/proto/soft_start_cosine_annealing_schedule_config.proto
...
SoftStartCosineAnnealingScheduleConfig = _reflection.GeneratedProtocolMessageType('SoftStartCosineAnnealingScheduleConfig', (_message.Message,), dict(
  ...
  __module__ = 'nvidia_tao_core.proto.soft_start_cosine_annealing_schedule_config_pb2'
