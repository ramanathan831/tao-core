...
# source: nvidia_tao_core/proto/adam_optimizer_config.proto
...
AdamOptimizerConfig = _reflection.GeneratedProtocolMessageType('AdamOptimizerConfig', (_message.Message,), dict(
  ...
  __module__ = 'nvidia_tao_core.proto.adam_optimizer_config_pb2'
