...
# source: nvidia_tao_core/proto/wandb_config.proto
...
WandBConfig = _reflection.GeneratedProtocolMessageType('WandBConfig', (_message.Message,), dict(
  ...
  __module__ = 'nvidia_tao_core.proto.wandb_config_pb2'
