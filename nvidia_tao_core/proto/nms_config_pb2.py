...
# source: nvidia_tao_core/proto/nms_config.proto
...
NMSConfig = _reflection.GeneratedProtocolMessageType('NMSConfig', (_message.Message,), dict(
  ...
  __module__ = 'nvidia_tao_core.proto.nms_config_pb2'
