...
# source: nvidia_tao_core/proto/regularizer_config.proto
...
RegularizerConfig = _reflection.GeneratedProtocolMessageType('RegularizerConfig', (_message.Message,), dict(
  ...
  __module__ = 'nvidia_tao_core.proto.regularizer_config_pb2'
