...
class SegformerHeadConfig:
    ...
    # @seanf this for mmseg is what decoder_params:embed_dim is to us...
...
class ResizeCfg:
    ...
    img_scale: Optional[List[int]] = LIST_FIELD(arrList=None, default_type=None, description="Image scale for the augmentation", display_name="Image Scale")  # configurable
...
class SFTrainExpConfig:
    ...
    num_gpus: int = INT_FIELD(value=1, default_value=1, description="Number of GPUs", display_name="Number of GPUs", min_value=1, popular="yes")
    gpu_ids: List[int] = LIST_FIELD(arrList=[0], description="GPU IDs", display_name="GPU IDs")
    max_iters: int = INT_FIELD(value=10, description="Maximum iterations", display_name="Maximum iterations", min_value=1, popular="yes")
    logging_interval: int = INT_FIELD(value=1, description="Logging interval", display_name="Logging interval")
    checkpoint_interval: int = INT_FIELD(value=1, description="Checkpoint interval", display_name="Checkpoint interval", popular="yes")
    ...
    validation_interval: Optional[int] = INT_FIELD(value=1, default_value=1, description="Validation interval", display_name="Validation interval", popular="yes")
...
class SFExportExpConfig:
    ...
    input_channel: int = INT_FIELD(value=3, description="Input channel", display_name="Input channel", valid_options="1,3", popular="yes")
...
class ExperimentConfig:
    ...
    results_dir: str = STR_FIELD(value="/results", default_value="/results", description="Results directory", display_name="Results directory")
