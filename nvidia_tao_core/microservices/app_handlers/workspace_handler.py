...
class WorkspaceHandler:
    ...
    def retrieve_workspace(user_id, org_name, workspace_id):
        ...
        """
        from nvidia_tao_core.microservices.handlers.stateless_handlers import resolve_metadata
    ...
    def delete_workspace(org_name, workspace_id):
        ...
        mongo_users = MongoHandler("tao", "users")
        from nvidia_tao_core.microservices.handlers.stateless_handlers import get_user
