...
@workspaces_bp_v1.route('/orgs/<org_name>/workspaces/<workspace_id>/backup', methods=['POST'])
@disk_space_check
...
@workspaces_bp_v1.route('/orgs/<org_name>/workspaces/<workspace_id>/restore', methods=['POST'])
@disk_space_check
