...
"""Workspaces blueprint for API v2 workspace management endpoints."""
...
# v2 Workspaces Blueprint - URL prefix will be set during registration
workspaces_bp_v2 = Blueprint('workspaces_v2', __name__, template_folder='templates')


@workspaces_bp_v2.route('/orgs/<org_name>/workspaces', methods=['GET'])
@disk_space_check
...
@workspaces_bp_v2.route('/orgs/<org_name>/workspaces/<workspace_id>', methods=['GET'])
@disk_space_check
...
@workspaces_bp_v2.route('/orgs/<org_name>/workspaces/<workspace_id>:get_datasets', methods=['GET'])
@disk_space_check
...
@workspaces_bp_v2.route('/orgs/<org_name>/workspaces/<workspace_id>', methods=['DELETE'])
@disk_space_check
...
@workspaces_bp_v2.route('/orgs/<org_name>/workspaces', methods=['DELETE'])
@disk_space_check
...
@workspaces_bp_v2.route('/orgs/<org_name>/workspaces', methods=['POST'])
@disk_space_check
...
@workspaces_bp_v2.route('/orgs/<org_name>/workspaces/<workspace_id>', methods=['PATCH'])
@disk_space_check
...
@workspaces_bp_v2.route('/orgs/<org_name>/workspaces/<workspace_id>/backup', methods=['POST'])
@disk_space_check
...
@workspaces_bp_v2.route('/orgs/<org_name>/workspaces/<workspace_id>/restore', methods=['POST'])
@disk_space_check
